...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-f8974bbffba0746c"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-f8974bbffba0746c",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-f8974bbffba0746c",
        "url": "https://en.wikipedia.org/wiki/Polignac%27s_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Polignac's conjecture : for all positive even numbers $n$ , there are infinitely many prime gaps of size $n$ .",
      "version": 1
    },
    "title": "Polignac's conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "a475436aa05307558c08b938476d45e8e742710122dbdb57ea8f4f034b0c7e5c"
}
```
